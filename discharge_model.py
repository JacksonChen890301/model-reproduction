...
class Dim_Reduction_1(nn.Module):  # for EOL/RUL
    def __init__(self, in_ch, out_ch):
        ...
        self.spacial_drop1 = SpatialDropout(0.20)
        ...
        self.spacial_drop2 = SpatialDropout(0.20)
        self.gloavgpool = nn.AvgPool1d(31, 1)
        self.glomaxpool = nn.MaxPool1d(31, 1)
    ...
    def forward(self, x):
        ...
        conv3_out = self.spacial_drop2(torch.cat((conv3_1, conv3_2), dim=1))
...
class Dim_Reduction_2(nn.Module):  # for charge time
    def __init__(self, in_ch, out_ch):
        ...
        self.maxpool2_2 = nn.MaxPool1d(2, 2)
        self.avgpool1 = nn.AvgPool1d(2, 2)
        self.gloavgpool = nn.AvgPool1d(62, 1)
        self.glomaxpool = nn.MaxPool1d(62, 1)
