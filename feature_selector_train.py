...
def get_args_parser():
    ...
    parser.add_argument('--detail_step', default=100, type=int)
    ...
    parser.add_argument('--load_checkpoint', default='Feature_Selector_2_s44.pth', type=str)                  
    ...
    parser.add_argument('--anneal_period', type=int, default=20, metavar='LR')
...
def main(args):
    ...
    for epoch in range(args.epochs):
        ...
        if rmse < best_rmse:
            ...
            pred_result(model, trn_loader, 'trn', args.pred_target)        
            pred_result(model, val_loader, 'val', args.pred_target)
